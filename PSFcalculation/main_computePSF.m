...
zmax =      6*1e-6; %% the axial location of the highest z-plane with respect to the focal plane
...
save(['../PSF/Ideal_psf_M',num2str(M),'_NA',num2str(NA),'_zmin',num2str(zmin*1e+6),'u_zmax',num2str(zmax*1e+6),'u.mat'],'psf','-v7.3');
