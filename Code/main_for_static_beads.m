...
% Preparameters
filepath='../Data/01_Raw/exampleData_Static/20200628Beads.tif'; %% the filepath of raw scanning light field data
...
if ExperimentalPSF==0
    load('../PSFmatrix/Ideal_psf_M63_NA1.4_zmin-8u_zmax8u.mat'); %% the filepath of ideal PSF
else
    load('../PSFmatrix/Experimental_psf_M63_NA1.4_zmin-8u_zmax8u.mat','psf'); %% the filepath of experimental PSF
end
...
imwriteTFSK(single(gather(Xguess(21:end-20,21:end-20,1:end))),['../Data/02_Recon/exampleData_Static/Recon3D_20200628Beads.tif']);
